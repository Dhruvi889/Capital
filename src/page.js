    ...
    return (
        <div className="superb">
            ...
            <div className='homecbg'>
                ...
                <p className='homepara'>Home_Product Details</p>
            </div>
            <div className="supermainredbbgdivs">
                <div className="mainredbbgdivs">
                    <div>
                        <img src={latest7} />
                    </div>
                    <div>
                        ...
                        <div className="btnsvgdiv">
                            <button className="btncarta">Add to cart</button>
                            <div className="svgshare">
